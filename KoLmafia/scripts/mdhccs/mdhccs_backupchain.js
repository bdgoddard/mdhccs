...
/* harmony export */   "backupChain": () => (/* binding */ backupChain)
/* harmony export */ });
...
function backups() {
  ...
  topupMP();
  hotTub();
  libram__WEBPACK_IMPORTED_MODULE_2__.Macro.skill((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject || (_templateObject = _taggedTemplateLiteral(["back-up to your last enemy"])))).if_('!monstername "sausage goblin"', new libram__WEBPACK_IMPORTED_MODULE_2__.Macro().step('abort')).skill((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["Curse of Weaksauce"])))).skill((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["saucegeyser"])))).setAutoAttack();

  while ((0,libram__WEBPACK_IMPORTED_MODULE_2__.get)('_backUpUses') < 11) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.adv1)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["Noob Cave"]))), -1, '');

    while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myHp)() < 0.8 * (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myMaxhp)()) {
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.useSkill)(1, (0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["Cannelloni Cocoon"]))));
    }
  }
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = "./src/backupchain.ts");
