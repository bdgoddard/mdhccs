...
function reminisceTest(monster) {
  /*
  ...
  .setAutoAttack();
  */
  libram__WEBPACK_IMPORTED_MODULE_2__.Macro.skill((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject || (_templateObject = _taggedTemplateLiteral(["saucestorm"])))).repeat().setAutoAttack(); // block first attack

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.equip)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["acc1"]))), (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["Eight Days a Week Pill Keeper"])))); //visitUrl("choice.php?pwd&whichchoice=1463&option=1&mid=" + monster.getId());
  //visitUrl("choice.php?pwd&whichchoice=1463&option=1&mid=" + toInt(monster));

  (0,_phredhccs_lib__WEBPACK_IMPORTED_MODULE_1__.reminisce)(monster);
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setAutoAttack)(0);
}

function main() {
  //reminisce($monster`bookbat`);
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("".concat((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.toInt)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$monster)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["bookbat"]))))));
  reminisceTest((0,libram__WEBPACK_IMPORTED_MODULE_2__.$monster)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["bookbat"])))); //print(`${toInt($monster`bookbat`)}`);
}
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = "./src/testrem.ts");
