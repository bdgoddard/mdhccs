import { adv1, autosell, availableAmount, cliExecute, create, eat, equip, getProperty, 
         myHp, myMaxhp, myMp, print, sell, setAutoAttack, toInt, useSkill, visitUrl } from "kolmafia";
...
export function firstFights() {
    ...
    if (ghostLocation) {
        ...
        autosell(availableAmount($item`frigid derringer`), $item`frigid derringer`);
    }
